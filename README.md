...
* dim_applications - contain product application data and foreign keys to other tables
* dim_products - contain modelled product data
* dim_countries - contains sample set of countries
* dim_channel - contains sample set of typical Marketing channels
